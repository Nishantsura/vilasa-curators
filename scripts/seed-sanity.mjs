...
const destinations = [
  {
    ...
    story: 'Marble from Carrara, hand-knotted wool from Prato, the geometric vocabulary of a language spoken in tiles.',
  ...
  },
  {
    ...
    story: "Lacquerware from Hanoi's old quarter. Rattan from the Mekong delta. Forms that take months to arrive at their own simplicity.",
  ...
  },
  {
    ...
    story: 'The artisans here have no word that separates decoration from devotion.',
  ...
  },
  {
    ...
    story: 'Talavera, obsidian, hand-hammered copper: a tradition where beautiful and useful are the same word.',
